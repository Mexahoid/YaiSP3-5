...
namespace AgencySimulator.Drawers
{
    ...
    public class BillboardDrawer : DrawingWrapperTemplate
    {
        ...
        public BillboardDrawer(IBillboard Billboard, int CityHeight)
        {
            billboard = Billboard;
        ...
        public bool IsValid()
        {
            return billboard.GetState() != BillboardState.Invalid;
        }
