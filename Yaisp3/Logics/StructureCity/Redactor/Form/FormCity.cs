...
namespace Yaisp3
{
    public partial class FormCity : Form
    {
        ...
        private void CtrlButMarkClick(object sender, EventArgs e)
        {
            ...
            Drawers.AddDrawer(new GridDrawer((int)(CtrlNumCityWidth.Value), (int)(CtrlNumCityHeight.Value)));
        ...
        private void CtrlPicBxCity_Paint(object sender, PaintEventArgs e)
        {
            Drawers.Draw();
        }
    }
