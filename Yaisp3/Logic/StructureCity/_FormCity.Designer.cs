namespace Yaisp3
{
  partial class _FormCity
  {
    ...
    private void InitializeComponent()
    {
      ...
      // _ctrlReset
      // 
      this._ctrlReset.Location = new System.Drawing.Point(468, 290);
      ...
      // _ctrlButSave
      // 
      this._ctrlButSave.Enabled = false;
      this._ctrlButSave.Location = new System.Drawing.Point(468, 407);
      this._ctrlButSave.Name = "_ctrlButSave";
      this._ctrlButSave.Size = new System.Drawing.Size(113, 23);
      this._ctrlButSave.TabIndex = 12;
      this._ctrlButSave.Text = "Сохранить";
      this._ctrlButSave.UseVisualStyleBackColor = true;
      this._ctrlButSave.Click += new System.EventHandler(this._ctrlButSave_Click);
      // 
      // _ctrlButLoad
      // 
      this._ctrlButLoad.Location = new System.Drawing.Point(468, 436);
      this._ctrlButLoad.Name = "_ctrlButLoad";
      this._ctrlButLoad.Size = new System.Drawing.Size(113, 23);
      this._ctrlButLoad.TabIndex = 13;
      this._ctrlButLoad.Text = "Загрузить";
      this._ctrlButLoad.UseVisualStyleBackColor = true;
      this._ctrlButLoad.Click += new System.EventHandler(this._ctrlButLoad_Click);
      // 
      // _FormCity
      // 
      ...
      this.Controls.Add(this._ctrlButLoad);
      this.Controls.Add(this._ctrlButSave);
    ...
    private System.Windows.Forms.Button _ctrlButSave;
    private System.Windows.Forms.Button _ctrlButLoad;
  }
}